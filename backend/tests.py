...
class ShipmentLogAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        for i in range(1, 26):
            self.logs.append(ShipmentLog.objects.create(
    ...
    def test_sorting_by_date_blocked(self):
        ...
        self.assertEqual(
            response_default.data['results'][0]['id'],
            response_date.data['results'][0]['id']
        )
    ...
    def test_forced_db_population_logic(self):
        ...
        for _ in range(5):  # Генерируем тестовую мини-партию
            ...
            logs_to_create.append(ShipmentLog(
                name=route_name, quantity=10, distance=100.0
            ))
